 ...
 * @author maimaimai
 */
@WebServlet(name = "DATABASEkadai6", urlPatterns = {"/DATABASEkadai6"})
public class DATABASEkadai6 extends HttpServlet {
        ...
        //テーブルの全要素表示
            ...
            while(db_data.next()){
                out.print("ID:" + db_data.getString("profilesID") +"名前:" + db_data.getString("name") 
                        + "電話番号：" + db_data.getString("tell") + "年齢:" + db_data.getString("age") + "誕生日:" + db_data.getString("birthday") +"<br>");
            }
        //ここまで
            db_data.close();
            db_st.close();
