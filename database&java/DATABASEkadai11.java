 ...
 * @author maimaimai
 */
public class DATABASEkadai11 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String b2 = request.getParameter("tell");
        String b3 = request.getParameter("age");
        String b4 = request.getParameter("birthday");
        
        int i1= Integer.valueOf(a);
        int i2= Integer.valueOf(b3);
        ...
        //課題7   
            ...
            db_st.setString(1,b1);
            db_st.setString(2,b2);
            db_st.setInt(3,i2);
            db_st.setString(4,b4);
            db_st.setInt(5,i1);
            db_st.executeUpdate();
        //ここまで
        //テーブルの全要素表示
