...
public class UserDataBeans implements Serializable{
    ...
    public void DTO2UDMapping(UserDataDTO udd){
       ...
       this.setYear(String.valueOf(cal.get(Calendar.YEAR)));
       this.setMonth(String.valueOf(cal.get(Calendar.MONTH)+1));
       this.setDay(String.valueOf(cal.get(Calendar.DATE)));
       
       //Dateをカレンダークラスに変換して切り分ける
