...
if(udb.getName().equals("")){ 
      out.write("\n");
      out.write("        名前が未入力です。<br>\n");
      out.write("    ");
}if(udb.getYear() == 0){
      out.write("\n");
      out.write("        年が未入力です。<br>\n");
      out.write("    ");
}if(udb.getMonth() == 0){
      out.write("\n");
      out.write("        月が未入力です。<br>\n");
      out.write("    ");
}if(udb.getDay() == 0){
      out.write("\n");
      out.write("        日が未入力です。<br>\n");
      out.write("    ");
}if(udb.getTell().equals("")){
      out.write("\n");
      out.write("        電話番号が未入力です。<br>\n");
      out.write("    ");
}if(udb.getComment().equals("")){
      out.write("\n");
      out.write("        自己紹介文が未入力です。<br>\n");
      out.write("    ");
}
      out.write("      \n");
      out.write("    ");
...
//課題５
      ...
      out.write("            <input type=\"hidden\" name=\"insertFlg\" value=reinput>\n");
      out.write("        </form>\n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
