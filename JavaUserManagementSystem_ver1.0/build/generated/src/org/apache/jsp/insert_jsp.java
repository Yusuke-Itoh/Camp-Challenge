...
//課題１
    ...
    if(request.getParameter("insertFlg").equals("reinput")){
...
//初期値の設定
      ...
      out.write("\" \n");
      out.write("                    ");
if(i==udb.getYear()){out.print("selected");}
      out.write('>');
      out.write(' ');
      out.print(i);
      out.write(" </option>\n");
...
for(int i = 1; i<=12; i++){
      ...
      out.write('"');
      out.write(' ');
if(i==udb.getMonth()){out.print("selected");}
      out.write('>');
      out.print(i);
      out.write("</option>\n");
      out.write("            ");
...
for(int i = 1; i<=31; i++){
      ...
      out.write('"');
      out.write(' ');
if(i==udb.getDay()){out.print("selected");}
      out.write('>');
      out.print(i);
      out.write("</option>\n");
      out.write("            ");
...
//種別はvalueが使えない 要調べ
      ...
      out.write("        種別:\n");
      out.write("        ");
//getTypeを使って取得した数値でif文書いて分岐分岐分岐
      out.write("\n");
      out.write("        <br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"1\" ");
if(udb.getType() == 1){out.print("checked");}
      out.write(">エンジニア<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"2\" ");
if(udb.getType() == 2){out.print("checked");}
      out.write(">営業<br>\n");
      out.write("        <input type=\"radio\" name=\"type\" value=\"3\" ");
if(udb.getType() == 3){out.print("checked");}
      out.write(">その他<br>\n");
      out.write("        <br>\n");
      out.write("\n");
      out.write("        電話番号:\n");
      ...
      out.write("        自己紹介文\n");
      out.write("        <br>\n");
      out.write("        <textarea name=\"comment\" rows=10 cols=50 style=\"resize:none\" wrap=\"hard\" value=\"");
